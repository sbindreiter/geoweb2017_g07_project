...
const ruheLayer = new VectorLayer({
  source: new Vector({
    url: 'https://student.ifip.tuwien.ac.at/geoweb/2017/g07/map/postgis_li_geojson.php',
    format: new GeoJSON()
  }),
  zIndex: 3
});
...
map.on('singleclick', function(e) {
  ...
  if (markup) {
    ...
    markup += `<form method="POST" action="https://student.ifip.tuwien.ac.at/geoweb/2017/g07/php/insert_point.php?pos=${pos.join(' ')}">`;
    markup += '         <fieldset>';
